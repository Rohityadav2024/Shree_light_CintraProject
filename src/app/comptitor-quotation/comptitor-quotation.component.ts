...
@Component({
  selector: 'app-comptitor-quotation',
  templateUrl: './comptitor-quotation.component.html',
  styleUrls: ['./comptitor-quotation.component.scss']
})
export class ComptitorQuotationComponent implements OnInit {
    ...
    ngOnInit(): void {
      ...
      this.Headingss = this.HeadingServices.getModule26();
    ...
    getOrders(): void {
      ...
      this.setPrevious();
      this.bridgeService2.getComptitorQuotationByPagination(this.pagination,this.searchValue,this.filter_customer,this.order_by_field,this.order_by_value).subscribe(
        (data: any) => {
          if (data.status == "200") {
  ...
  jsonpart(val:any){
    ...
    GetAppHistory(id:any){
      this.bridgeService2.AppruvedHistory(id,6).subscribe(
        (res: any) => {
          if (Object(res)['status'] == "200") {
