...
@Component({
  selector: 'app-addeditcomptitorquotation',
  templateUrl: './addeditcomptitorquotation.component.html',
  styleUrls: ['./addeditcomptitorquotation.component.scss']
})
export class AddeditcomptitorquotationComponent implements OnInit {
  ...
  isEdit:boolean=false;
    ngOnInit(): void {
      if (!this.HeadingServices.isModuleView(6) || !this.HeadingServices.isModuleViewadd(6)) {
